...
Retained verification scripts import from here so claim checks, interval
computation, latency measurement, and release reporting share the same loading
and metric code.
...
def _default_num_workers() -> int:
    """Single-process default keeps verification runnable in restricted shells."""
    return int(os.environ.get("SAFECOMMUTE_NUM_WORKERS", "0"))
