...
const STEPS = [
  ...
  { n: "04", t: "Site fine-tune", d: "30+ min recorded ambient + majority-k=2 aggregation. Held-out site FP 0.0% on metro (n=1); recall 78.9%; universal speech FP 72% → 16.9%.", featured: true },
